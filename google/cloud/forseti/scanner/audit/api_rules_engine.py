...
"""Rules engine for whitelisting API Usage"""
import itertools
import re
import urllib2
import struct
...
class APIRulesEngine(bre.BaseRulesEngine):
...
class APIRulesbook(bre.BaseRuleBook):
    ...
    def __init__(self,
        ...
        Args:
            rule_defs (dict): The parsed dictionary of rules from the YAML
                definition file.
        """
        super(APIRulesbook, self).__init__()
